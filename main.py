...
from option_pricing import BlackSholesModel, MonteCarloPricing, BinomialTreeModel, Ticker

class OPTION_PRICING_MODEL(Enum):
    BLACK_SHOLES = 'Black Sholes Model'
...
if pricing_method == OPTION_PRICING_MODEL.BLACK_SHOLES.value:
    ...
    if st.button(f'Calculate option price for {ticker}'):
        ...
        BSM = BlackSholesModel(spot_price, strike_price, days_to_maturity, risk_free_rate, sigma)
